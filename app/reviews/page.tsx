...
export const metadata = {
  title: "All SaaS Reviews | SoftRYT",
  description: "Browse our complete directory of in-depth, AI-generated reviews of the most popular B2B SaaS tools.",
};
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 min-h-screen">
      <div className="mb-10">
        ...
        <p className="text-muted-foreground text-lg max-w-2xl">
          Browse our complete directory of in-depth, AI-generated reviews of the most popular B2B SaaS tools.
        </p>
      </div>
