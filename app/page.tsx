        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 sm:pt-28 sm:pb-24">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed mb-8 max-w-2xl mx-auto">
              Data-driven SaaS comparisons powered by real-time pricing scraping
              and AI analysis. Stop guessing, start comparing.
            </p>
            ...
            {[
              {
                ...
                title: "Real Data",
                description:
                  "Pricing and features scraped directly from official sources. No outdated info.",
              },
              {
              ...
              },
              {
                ...
                title: "Auto-Updated",
                description:
                  "Weekly automated scraping detects pricing changes and regenerates content.",
              },
            ].map((prop) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          {typedReviewPages.length > 0 ? (
            ...
            <div className="text-center py-20 border border-dashed border-border/50 rounded-2xl bg-muted/10">
              ...
              <p className="text-sm text-muted-foreground/60">
                Reviews will appear here once generated by the AI pipeline.
              </p>
            </div>
          )}
        </div>
