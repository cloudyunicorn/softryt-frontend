...
export function ReviewCard({ page }: { page: GeneratedPage }) {
  ...
  return (
    <Link href={`/${page.slug}`}>
      <Card className="group h-full hover:border-brand-green/35 hover:shadow-md hover:shadow-brand-green/5 transition-all duration-300 border-hairline bg-card overflow-hidden flex flex-col rounded-lg">
        {/* Gradient accent bar */}
