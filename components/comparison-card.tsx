...
export function ComparisonCard({ page }: { page: GeneratedPage }) {
  ...
  return (
    <Card className="group relative h-full hover:border-brand-green/35 hover:shadow-md hover:shadow-brand-green/5 transition-all duration-300 border-hairline bg-card overflow-hidden rounded-lg">
      {/* Gradient accent bar */}
